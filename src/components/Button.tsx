...
export function Button({ children, ...rest }: Props) {
  return (
    <button
      {...rest}
      className="w-auto h-[52px] flex items-center bg-blue-dark text-gray-100 rounded-lg p-4 font-bold text-sm gap-2 hover:bg-blue hover:transition-all duration-100"
      type="submit"
    >
      {children}
      <svg
